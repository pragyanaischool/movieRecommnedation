# -*- coding: utf-8 -*-
"""App_ForRecommedationSystem.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/15T_v5p4oOCeUVo2DFnAFTuRUG0TS4ThR
"""
...
def fetch_poster(movie_id):
    response = requests.get('https://api.themoviedb.org/3/movie/{}?api_key=4f26810245b768489a195238ffe92a0b&language=en-US'.format(movie_id))
    data = response.json()
